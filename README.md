...
| **entity extraction** | Zero-shot NER (GLiNER) and schema-driven structured records (GLiFormer) over text, CPU-friendly | [`gliner`](https://huggingface.co/datasets/uv-scripts/gliner) |
