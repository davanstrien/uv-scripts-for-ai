...
| [`falcon-ocr.py`](https://huggingface.co/datasets/uv-scripts/ocr/blob/main/falcon-ocr.py) | [Falcon-OCR](https://huggingface.co/tiiuae/Falcon-OCR) | 0.3B | falcon-perception | Smallest VLM in collection. #1 on multi-column docs and tables (olmOCR), Apache 2.0. Repo root is **v1.5** since 2026-09-11 (in-place weight swap); `--revision` pins v1 (`42ec56b7…`) or v1.5 (`fe757d59…`) |
